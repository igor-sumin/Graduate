...
public:
    ...
    SerialSweepMethod(vec a, vec c, vec b, vec phi, pairs kappa_, pairs mu_, pairs gamma_, TASK task_) :
            SerialInstrumental(std::move(a), std::move(c), std::move(b), std::move(phi), kappa_, mu_, gamma_, task_) {}
